...
const projects = {
            ...
            2: {
                ...
                abstract: '일반적인 산업분류로 잡아내기 어려운 기업 간 관계를 SEC 10-K에서 포착했습니다. 사업 설명의 유사도와 회사 이름 언급으로 탐색 범위를 넓히고, 경쟁·공급·협력 관계를 공시 근거와 함께 보여주는 웹앱을 구축했습니다. 관계 그래프에서 기업을 선택하면 연결된 이유를 원문으로 확인할 수 있습니다.',
