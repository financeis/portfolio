...
const projects = {
            ...
            2: {
                ...
                abstract: '일반적인 산업분류로 잡아내기 어려운 기업 간 관계를 SEC 10-K에서 포착했습니다. 사업 설명의 유사도와 회사 이름 언급으로 탐색 범위를 넓히고, 경쟁·공급·협력 관계를 공시 근거와 함께 보여주는 웹앱을 구축했습니다. 관계 그래프에서 원문을 확인하고, 2024·2025년 공시에 나타난 연결을 비교했습니다.',
                desc: 'GICS·SIC만으로는 업종을 넘는 경쟁, 고객·공급망, 기술 협력 관계를 충분히 읽기 어렵습니다. S&P 500 기업의 10-K를 수집·정제하고 TF-IDF와 임베딩을 결합해 비교 대상을 찾았습니다. 공시에 등장하는 기업명과 주변 문맥을 판정해 관계 유형과 근거 문장을 연결하고, 기업 검색·관계도·원문 조회·검수를 React·FastAPI 웹앱으로 구현했습니다.',
                research: {
                    heading: '기업 관계를 찾고 근거를 확인하는 흐름',
                    facts: [
                        { value: '494개 기업', label: '2025년 제출 10-K 관계 분석 대상' },
                        { value: '546 / 509', label: '2025년 경쟁 / 공급·협력 관계 수 · 익명 고객 제외' },
                        { value: '2024 → 2025', label: '동일한 판정 설정으로 공시 관계 비교' }
                    ],
                    approaches: [
                        {
                            label: '01 / DISCOVER',
                ...
                highlights: [
                    '산업분류 밖의 관계 탐색 — NVIDIA와 다른 섹터에 속한 Amazon·Alphabet·Tesla의 경쟁 관계처럼 분류표만으로 놓치기 쉬운 연결을 공시 근거와 함께 제시했습니다.',
                    '탐색에서 검수까지 — 기업 검색, 관계 유형·섹터 필터, 그래프 확대·PNG 저장, 원문 조회, 관계 검수와 표본 검수를 하나의 웹앱으로 연결했습니다.',
                    '연도별 관계 비교 — 2024·2025년 관계도를 동일 설정으로 구성하고, 유지·새로 보임·보이지 않음을 집계했습니다. 이름 언급과 판정의 변화, 공시 추출 범위 차이도 구분했습니다.',
                    '비교 결과 — 2025년 경쟁 546개·공급·협력 509개 관계를 집계했습니다(익명 고객 제외, 유형별 집계). 두 해 유사도가 모두 있는 472개사의 상위 20개 이웃 유지율은 평균 88%였습니다.',
